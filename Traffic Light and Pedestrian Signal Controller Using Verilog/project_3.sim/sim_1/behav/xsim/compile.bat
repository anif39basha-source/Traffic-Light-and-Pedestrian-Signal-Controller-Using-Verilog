...
REM
REM Generated by Vivado on Thu Nov 27 16:09:05 +0530 2025
...
echo "xvlog --incr --relax -prj tb_traffic_light_ped_vlog.prj"
call xvlog  --incr --relax -prj tb_traffic_light_ped_vlog.prj -log xvlog.log
